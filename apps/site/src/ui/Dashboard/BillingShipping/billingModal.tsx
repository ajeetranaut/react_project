...
const BillingModal = ({
	...
	const billingOnSubmit = async (data: any) => {
		setLoader(true)
		startTransition(() => {
			updateUser({
				billing: data
		...
		<div className={`fixed inset-0 z-50 overflow-y-auto ${modal === 1 ? "block" : "hidden"}`}>
			...
			<div className="absolute left-0 right-0 top-0 bottom-0 rounded-lg transform transition-all max-w-3xl w-full h-fit m-auto overflow-y-auto">
				<div className="bg-white p-4 w-full rounded-lg">
					...
					<form onSubmit={handleSubmit(billingOnSubmit)}>
						<div className="space-y-2 sm:space-y-5 mt-6 w-full">
							<div className="flex flex-wrap md:flex-nowrap items-center gap-2 sm:gap-5">
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.first_name ? "border-red-400 text-red-400" : ""
										}`}
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.last_name ? "border-red-400 text-red-400" : ""
										}`}
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.company ? "border-red-400 text-red-400" : ""
										}`}
							...
							<div className="flex flex-wrap md:flex-nowrap items-center gap-2 sm:gap-5">
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.email ? "border-red-400 text-red-400" : ""
										}`}
								...
								>
									<option value="">{billing?.country === "" ? textData?.fromText?.countryPlaceholder : billing?.country}</option>
									{country.map((item, index) => (
										<option key={index} value={item.isoCode} selected={item.isoCode === billing?.country}>
											{item.flag} {item.name}
										</option>
									))}
								</select>
							...
							<div className="flex  items-center gap-2 sm:gap-5">
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.address_1 ? "border-red-400 text-red-400" : ""
										}`}
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.address_2 ? "border-red-400 text-red-400" : ""
										}`}
							...
							<div className="flex flex-wrap md:flex-nowrap items-center gap-2 sm:gap-5">
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.state ? "border-red-400 text-red-400" : ""
										}`}
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.city ? "border-red-400 text-red-400" : ""
										}`}
								...
								<input
									...
									className={`focus:outline-none border rounded-md px-5 h-11 w-full focus:shadow-lg focus:shadow-outline placeholder:text-sm ${errors?.postcode ? "border-red-400 text-red-400" : ""
										}`}
